...
class Algorithms:
    ...
    def ExponentialSearch(self):
        ...
        This algorithm works by finding a range where the element is present, then doing binary search.
        It's particularly useful for unbounded searches and when the element is near the beginning.
